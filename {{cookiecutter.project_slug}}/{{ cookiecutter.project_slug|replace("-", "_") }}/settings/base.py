...
ROOT_URLCONF = "__PROJECT_PACKAGE__.urls"
...
WSGI_APPLICATION = "__PROJECT_PACKAGE__.wsgi.application"
...
if AUTH_STYLE == "vedio":
    AUTH_STYLE = "video"
AUTH_MEDIA = {
    "login": os.environ.get("AUTH_LOGIN_MEDIA", "accounts/brand/logo.png"),
    "register": os.environ.get("AUTH_REGISTER_MEDIA", "accounts/brand/logo.png"),
    "password_reset": os.environ.get(
        "AUTH_PASSWORD_RESET_MEDIA", "accounts/brand/logo.png"
    ),
}
...
LOGGING: dict[str, Any] = {
    ...
    "handlers": {
        "loguru": {
            "class": "__PROJECT_PACKAGE__.logging.InterceptHandler",
        }
    },
    "root": {
        "handlers": ["loguru"],
