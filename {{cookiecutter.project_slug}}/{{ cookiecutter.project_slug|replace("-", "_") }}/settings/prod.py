from __PROJECT_PACKAGE__.logging import configure_logging
...
COOKIE_SECURE = get_env_bool("DJANGO_COOKIE_SECURE", False)
SESSION_COOKIE_SECURE = get_env_bool("DJANGO_SESSION_COOKIE_SECURE", COOKIE_SECURE)
CSRF_COOKIE_SECURE = get_env_bool("DJANGO_CSRF_COOKIE_SECURE", COOKIE_SECURE)
