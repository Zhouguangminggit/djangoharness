...
from __PROJECT_PACKAGE__.logging import InterceptHandler

os.environ.setdefault("DJANGO_SETTINGS_MODULE", "__PROJECT_PACKAGE__.settings.dev")

app = Celery("__PROJECT_PACKAGE__")
