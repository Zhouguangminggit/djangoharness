...
```powershell
uv run ruff format apps __PROJECT_PACKAGE__ celery_app tests manage.py
uv run ruff check apps __PROJECT_PACKAGE__ celery_app tests manage.py
uv run mypy apps __PROJECT_PACKAGE__ celery_app tests manage.py
uv run pytest
```
