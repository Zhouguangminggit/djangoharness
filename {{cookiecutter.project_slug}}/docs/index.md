...
[查看源码](https://github.com/Zhouguangminggit/__PROJECT_SLUG__){ .md-button }

</div>

__PRODUCT_NAME__ 是面向 AI 和 Agent 的 Django 业务开发框架。本站集中展示框架能力、开发工具、
...
- :material-cube-outline:{ .lg .middle } **框架能力**
  ...
  配置 Celery、Unfold 和 __PRODUCT_NAME__ 内置能力。
